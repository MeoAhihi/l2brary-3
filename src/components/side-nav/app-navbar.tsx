...
export function AppNavbar() {
  ...
  return (
    <nav className="bg-background sticky top-0 z-40 flex items-center justify-between border-b px-4 py-2">
      {/* Logo on the left */}
      <div className="flex items-center">
        <Link href="/" className="flex items-center gap-2 text-lg font-bold">
          {/* You can replace this with an actual logo image if available */}
          <img src="/l2brary.ico" alt="L2brary logo" className="h-7 w-7" />
